var testMapLetters = ["t", "y", "p", "e", "r", "f"];
var testMapTiming = [2, 2.5, 3, 3.25, 3.5, 4]; //appears two seconds before given second
...
var testMapObjects = [letter1, letter2, letter3, letter4, letter5, letter6];
